# 注：这个已经是旧项目了，新项目仅需单主机（7950x+5080）训练6h即可达到比较强的人类的水平，训练24h即可远超任何人类
新项目地址：
```
https://github.com/liemark/popucom_chess_c-python
```
# 泡姆棋 (Popucom Chess)
...
数据保存到 self_play_data/ 目录。（目前在25000局自对弈后，在2000步搜索下达到大约人类平均水平，提供了一部分棋谱以供训练测试）
...
```
这将开始一个持续的自对弈和训练循环。
（本项目的多数代码由ai辅助生成，也进行了各种优化，如有bug主要为个人能力不足）
